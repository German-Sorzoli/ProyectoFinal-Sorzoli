# Curso de Coder House - Desarrollo Web
...
* [Host](https://hostinger.com/ar/) - Host web
...
Diseño responsive: grids + flexbox + box modeling (CSS nativo) Óptimo:
...
Diseño responsive: framework (Bootstrap) Óptimo:
El diseño responsive se encuentra excelentemente aplicado. No existe el overflow-x.
...
Contenido, diseño y estética Óptimo:
